          ...
          return ListView(
            ...
            children: [
              ...
              ProfileMenuCard(
                ...
                onTap: () => context.push('/member-retention?gymId=$gymId'),
              ),
              const SizedBox(height: 10),
              ProfileMenuCard(
                ...
                onTap: () => context.push('/marketing-assistant?gymId=$gymId'),
              ),
              const SizedBox(height: 10),
              ProfileMenuCard(
                icon: Icons.support_agent_rounded,
                title: 'Member Support Bot',
                subtitle: 'Q&A for timings, plans, trainers & diet — shown in member app',
                onTap: () => context.push('/support-faqs?gymId=$gymId'),
              ),
              const SizedBox(height: 10),
              ProfileMenuCard(
                ...
                onTap: () => _openSection(context, ProfileSection.workoutPlans),
              ),
              const SizedBox(height: 10),
              ProfileMenuCard(
